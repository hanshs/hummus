...
export const scenariosRouter = trpc.router({
    ...
    update: protectedProcedure.input(z.object({ id: z.number(), data: z.object({ name: z.string() }) })).mutation(({ input, ctx }) => {
    ...
    removeStep: protectedProcedure.input(z.object({
        scenarioId: z.number(),
        stepId: z.number()
    ...
    reorderSteps: protectedProcedure.input(
        z.object({
            scenarioId: z.number(),
            steps: z.array(
